...
- Registration รับเฉพาะรหัสนิสิต 10 หลักที่หลักแรกเป็น 5, 6 หรือ 7 โดยตรวจทั้ง HTML/หน้าเว็บและ shared Firebase service; UI ไม่เปิดเผยกติกาหลักแรก และข้อความแจ้งเตือนระบุเพียงว่า `รหัสนิสิตไม่ถูกต้อง` / `Invalid student ID.`
