...
- Station images are sized at 114% so their purple edge is cropped out. Uncollected stations are grayscale; collected stations retain the green dashed border and show the station name centered over the image like the uncollected state.
