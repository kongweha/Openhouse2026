...
const db = window.openHouseDb;
        ...
        function exportCSV() {
            ...
            allUsers.forEach(item => {
                ...
                let status = passed === 0 ? "ยังไม่เริ่ม" : (passed < 7 ? "กำลังเล่น" : (item.user.isRedeemed ? "รับรางวัลแล้ว" : "ผ่านครบแล้ว"));
                ...
                let row = `"${item.code}","${status}","${passed}/7","${totalSec}",`;
